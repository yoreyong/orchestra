                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">Concert > Details </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <form action="" method="">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Price:</td>
                                                        <td>
                                                            <input class="text" style="width:100px;" type="number" step="0.01" name="price" value="${concert.price}" disabled="disabled"/>
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
