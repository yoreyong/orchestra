                                            ...
                                            <form action="concert.let?type=add" method="post">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Place:</td>
                                                        <td>
                                                           <input class="text" style="width:200px;" type="text" name="place" required />
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Date:</td>
                                                        <td>
                                                           <input class="text" style="width:100px;" type="text" name="date" required />
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Time:</td>
                                                        <td>
                                                            <input class="text" style="width:100px;" type="text" name="time" required />
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Price:</td>
                                                        <td>
                                                            <input class="text" style="width:100px;" type="number" step="0.01" name="price" required/>
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
