                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;"><b>Settings</b> > <b>Reset Pasword</b></h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <form  action="user.let?type=modifyPwd" method="post">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        ...
                                                        <td class="err">*Invalid password</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="newpwd2_err"class="err">New password does not match</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px"></td>
                                                        <td width="150px"><input class="btn" type="submit" value="Save" /></td>
                                                        <td ></td>
                                                        <td width="2%">&nbsp;</td>
