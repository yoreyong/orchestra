...
<%--                                                            <td>${m.SSN}</td>--%>
                                                            ...
                                                            <td>
                                                                <a onclick="return confirm('Are you sure?');" href="musician.let?type=modifypre&SSN=${m.SSN}">Modify</a>&nbsp;&nbsp;
                                                            	<a onclick="return confirm('Are you sure?');" href="musician.let?type=remove&SSN=${m.SSN}">Delete</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
