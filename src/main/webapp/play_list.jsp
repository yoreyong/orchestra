                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;"><b>Musician</b> > <b>Instrument</b></h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                        ...
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <c:forEach items="${plays}" var="r">
                                                <tr align="center" class="d">
                                                    ...
                                                    <td>
                                                        <a onclick="return confirm('Confirm deletion');" href="play.let?type=remove&pid=${r.id}"><u>Delete</u></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
