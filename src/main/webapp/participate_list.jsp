                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <c:forEach items="${participates}" var="m">
                                                <tr align="center" class="d">
                                                    <td>${m.id}</td>
                                                    <td><a href="musician.let?type=details&SSN=${m.musician.SSN}">${m.musician.SSN}</a></td>
                                                    <td>${m.musician.fname}</td>
                                                    <td>${m.musician.lname}</td>
                                                    <td>${m.musician.gender}</td>
                                                    <td>${m.musician.phoneNum}</td>
                                                    <td>
                                                        <a onclick="return confirm('Confirm deletion');" href="participate.let?type=remove&pid=${m.id}"><u>Delete</u></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
