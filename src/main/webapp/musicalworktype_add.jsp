                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;"> Musicalwork Type > Add a new type </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="musicalworktype.let?type=add" method="post">
                                                <table width="40%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="25%">Name：</td>
                                                        <td width="40%"><input type="text" id="typeName" name="typeName" /></td>
